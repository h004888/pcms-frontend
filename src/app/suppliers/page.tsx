...
import { Column, Input, Button, Textarea } from '@/components/ui';
...
export default function SuppliersPage() {
  ...
  const columns: Column<Supplier>[] = [
    ...
    { key: 'email', header: 'Email', render: (s) => <span className="text-sm text-gray-600">{s.email || '—'}</span> },
  ...
  return (
    <DashboardLayout>
      <ListPage<Supplier>
        ...
        customActions={(s) => (
          <button onClick={(e) => { e.stopPropagation(); handleDelete(s); }} className="p-1 text-gray-500 hover:text-red-600" title="Vô hiệu hóa">
