// =====================================================
// /customer/tra-cuu-thuoc/[slug] — SHOP-LOOKUP-DRUG detail
    ...
    <>
      ...
      <div className="bg-white border-b border-ink-200">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6">
          <Breadcrumb
            items={[
              { label: 'Tra cứu thuốc', href: '/customer/tra-cuu-thuoc' },
              { label: product.name },
            ]}
          />
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="flex justify-between items-center text-sm">
          <Link
            href="/customer/tra-cuu-thuoc"
            className="text-accent-700 hover:underline"
          >
            ← Quay lại danh sách thuốc
          </Link>
          <Link
            href="/customer/tra-thuoc-chinh-hang"
