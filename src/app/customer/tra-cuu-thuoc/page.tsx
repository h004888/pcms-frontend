// =====================================================
// /customer/tra-cuu-thuoc — SHOP-LOOKUP-DRUG: Tra cứu thuốc
    ...
    <>
      ...
      <div className="bg-white border-b border-ink-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          ...
          {/* Search form */}
          <form action="/customer/tra-cuu-thuoc" method="get" className="mt-6 max-w-2xl" role="search">
          ...
          <section aria-labelledby="browse-cat-title">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              {catCounts.map((cat) => (
                <Link
                  key={cat.id}
                  href={`/customer/tra-cuu-thuoc?cat=${cat.id}`}
