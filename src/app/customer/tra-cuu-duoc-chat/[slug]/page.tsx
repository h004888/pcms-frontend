// =====================================================
// /customer/tra-cuu-duoc-chat/[slug] — SHOP-LOOKUP-INGREDIENT detail
// =====================================================
    ...
    <>
      ...
      <div className="bg-white border-b border-ink-200">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6">
          <Breadcrumb
            items={[
              { label: 'Tra cứu hoạt chất', href: '/customer/tra-cuu-duoc-chat' },
              { label: ing.name },
            ]}
          />
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <section>
            ...
            <ul className="flex flex-wrap gap-2">
              {relatedIngredients.map((i) => (
                <li key={i.slug}>
                  <Link
                    href={`/customer/tra-cuu-duoc-chat/${i.slug}`}
        ...
        <div className="flex justify-between text-sm">
          <Link
            href="/customer/tra-cuu-duoc-chat"
            className="text-accent-700 hover:underline"
          >
            ← Quay lại danh sách hoạt chất
          </Link>
          <Link
            href="/customer/bai-viet"
