// =====================================================
// /customer/tra-cuu-duoc-chat — SHOP-LOOKUP-INGREDIENT: Tra cứu hoạt chất
    ...
    <>
      ...
      <div className="bg-white border-b border-ink-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          ...
          {/* Search form */}
          <form
            action="/customer/tra-cuu-duoc-chat"
            method="get"
            ...
            {INGREDIENT_CATEGORIES.map((cat) => {
              ...
              return (
                <Link
                  ...
                  href={
                    cat.id === 'all'
                      ? '/customer/tra-cuu-duoc-chat'
                      : `/customer/tra-cuu-duoc-chat?cat=${cat.id}`
                  }
                  className={clsx(
        ...
        {results.length === 0 ? (
          ...
          <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {results.map((ing) => (
              <li key={ing.slug}>
                <Link
                  href={`/customer/tra-cuu-duoc-chat/${ing.slug}`}
