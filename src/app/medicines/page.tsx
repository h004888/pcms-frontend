  ...
  const columns: Column<Medicine>[] = [
    ...
    { key: 'name', header: 'Tên thuốc', render: (m) => (
      <div className="flex items-center gap-2">
        <div className="p-1.5 bg-primary-50 rounded"><Pill className="w-4 h-4 text-primary-600" /></div>
        <div>
    ...
    { key: 'price', header: 'Giá', width: '130px', align: 'right', render: (m) => <span className="font-semibold text-medical-700">{formatVND(m.price)}</span> },
  ...
  return (
    <DashboardLayout>
      <ListPage<Medicine>
        ...
        customActions={(m) => (
          <button onClick={(e) => { e.stopPropagation(); handleDelete(m); }} className="p-1 text-gray-500 hover:text-red-600" title="Vô hiệu hóa">
