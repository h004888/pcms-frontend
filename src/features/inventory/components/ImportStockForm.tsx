...
export function ImportStockForm() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-ink-900">Nhập kho</h1>
        <p className="text-sm text-ink-500 mt-1">UC05 · Thêm lô hàng mới vào tồn kho (AT4: validate qty, batch, expiry)</p>
      </div>
