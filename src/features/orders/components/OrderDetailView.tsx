    ...
    <DashboardLayout>
      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-ink-500 mt-1">Ngày tạo: {formatDateTime(order.createdAt)}</p>
        </div>
        ...
        <div className="space-y-4">
          <Card title="Trạng thái">
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-ink-500">Mã đơn:</span>
          ...
          <Card title="Khách hàng">
            {customer ? (
              <div className="text-sm space-y-1">
                ...
                {customer.email && <p className="text-ink-500">✉️ {customer.email}</p>}
                <p className="text-accent-600">⭐ {customer.points} điểm</p>
              </div>
            ) : <p className="text-sm text-ink-500">ID: {order.customerId}</p>}
          </Card>
